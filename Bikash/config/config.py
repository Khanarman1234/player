...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Hayato")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/longcy")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/groupcy1")
